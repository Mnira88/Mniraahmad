    ...
    <div class="card card-statistics h-100">
     <div class="card-body">
           ...
           <div class="container">
             ...
             <form action="<?php echo e(route('visitors.update',session('user')->id)); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    <fieldset class="row" >
                                                        ...
                                                        <div class="col-sm-12 col-md-12">
                                                            ...
                                                            <input required type="text" name="name" class="form-control" id="name" value="<?php echo e($visitor->name); ?>" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            ...
                                                            <input required  type="number" pattern="[0-9]*" class="form-control" name="phone" id="phone"
                                                                placeholder="Ex.05xxxxxxxx" value="<?php echo e($visitor->phone); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            ...
                                                            <input required class="form-control" type="email" name="email" placeholder="your email"
                                                                id="email" value="<?php echo e($visitor->email); ?>">
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mnira\Downloads\emotion_final_v2\emotion\resources\views/visitors/profile.blade.php ENDPATH**/ ?>